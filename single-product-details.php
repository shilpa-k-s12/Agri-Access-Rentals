...
<html lang="en">
  <head>
    <title>Agriculture Equipment Rental Management System || Single Product Details</title>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <div class="rating d-flex">
                        ...
                        <strong style="padding-left: 10px;padding-right: 10px;">></strong>  
                        <p><?php echo $row['SubcategoryName'];?></p>
                    </div>
                    <p class="price"><span> Rent Price: $<?php echo $row['RentPrice'];?>/day</span></p>
                    <p>Model Number: <?php echo $row['ModelNumber'];?></p>
                    <p>Power Source: <?php echo $row['PowerSource'];?></p>
                    <p><?php echo $row['ProductDescription'];?></p>
                    <p><strong>Specifications:</strong> <?php echo $row['ProductSpecifications'];?></p>
                    <p><strong>Available Units:</strong> <?php echo $row['StockQuantity']; ?></p>
